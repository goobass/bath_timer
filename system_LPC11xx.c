...
void SystemInit (void) {
...
#if ((SYSPLLCLKSEL_Val & 0x03) == 1)							/* SYSPLLCLKSEL_Val      0x00000001  */

  LPC_SYSCON->PDRUNCFG     &=(unsigned int) ~(1 << 5);          /* Power-up System Osc      */
  LPC_SYSCON->SYSOSCCTRL    = SYSOSCCTRL_Val;     /*SYSOSCCTRL_Val        0x00000000 */
  ...
  LPC_SYSCON->MAINCLKSEL    = MAINCLKSEL_Val;     /* Select PLL Clock Output MAINCLKSEL_Val        0x00000000    */
